import "package:amazon_clone_final/common/widgets/custom_button.dart";
...
class _OrderDetailScreenState extends State<OrderDetailScreen> {
  ...
  void changeOrderStatus(int status) {
    //!!!Only For Admin
    adminServices.changeOrderStatus(context: context, status: status+1,
        order: widget.order, onSuccess: () {
      setState(() {
        currentStep +=1;
      });
        });
                          ...
                          children: [
                            ...
                            Expanded(
                              child: Column(
                                crossAxisAlignment: CrossAxisAlignment.start,
                                children: [
                                  Text(widget.order.products[i].name,style:const TextStyle(
                                     fontSize: 17,
                                    fontWeight: FontWeight.bold,
                                  ),
                                    maxLines: 2,
                ...
                child: Stepper(
                  ...
                  steps: [
                    ...
                    const Text('Completed '),
                        content: Text('Your Order has been delivered and you are yet to sign'),
